...
def clean_data(df):
    ...
    # remove last 2 characters from catergory names
    ...
    for column in categories:
        # set value as the last character.
    ...
    # concatenate the dataframe with `categories` dataframe
...
def save_data(df, database_filename):
    '''
    Save the data into the database. The destination table name is DisasterResponse
